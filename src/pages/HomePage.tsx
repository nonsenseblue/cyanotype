...
import { Calendar } from '@/components/viewer/Calendar';
  ...
  return (
    <article className="page" key="home">
      <article className="home">
          ...
          <div className="hero-decor" aria-hidden="true">
            ...
            <svg className="hero-mark hero-mark-5" viewBox="0 0 60 50">
              <path
                ...
                strokeLinejoin="round"
              />
              <circle cx="30" cy="30" r="8" fill="none" stroke="currentColor" strokeWidth="1.2" />
              <circle cx="30" cy="30" r="3" fill="none" stroke="currentColor" strokeWidth="1.2" />
        ...
        <ColophonRow label={t(issue.homeColophon)} />
