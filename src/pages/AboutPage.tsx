...
import { HandRule } from '@/components/decor/HandRule';
import { ColophonRow } from '@/components/layout/ColophonRow';
...
function HandUnderline() {
  return (
    <svg className="about-underline" viewBox="0 0 200 8" preserveAspectRatio="none" aria-hidden="true">
      <path
        pathLength="100"
...
function AboutStar({ extraClass = '' }) {
  return (
    <svg className={`about-star ${extraClass}`.trim()} viewBox="0 0 24 24" aria-hidden="true">
      <path
        d="M12,4 C13,9 14,10 18,11 C14,12 13,13 12,18 C11,13 10,12 6,11 C10,10 11,9 12,4 Z"
        fill="none" stroke="currentColor" strokeWidth="1.2"
        strokeLinecap="round" strokeLinejoin="round" vectorEffect="non-scaling-stroke"
...
function AboutCamera() {
  return (
    <svg className="about-camera" viewBox="0 0 60 50" aria-hidden="true">
      <path
        ...
        strokeLinejoin="round" vectorEffect="non-scaling-stroke"
      />
      <circle cx="30" cy="30" r="8" fill="none" stroke="currentColor" strokeWidth="1.2" vectorEffect="non-scaling-stroke" />
      <circle cx="30" cy="30" r="3" fill="none" stroke="currentColor" strokeWidth="1.2" vectorEffect="non-scaling-stroke" />
  ...
  return (
    <article className="page" key="about">
      <article className="about-page" lang="en">
        ...
        <ColophonRow label="cyanotype · 3030" />
      </article>
    </article>
  );
}
