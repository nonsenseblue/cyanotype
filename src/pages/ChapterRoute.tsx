...
import { Essay } from '@/components/viewer/Essay';
import { Viewer } from '@/components/viewer/Viewer';
import { DotsRule } from '@/components/decor/DotsRule';
import { HandRule } from '@/components/decor/HandRule';
import { ChapterMarks } from '@/components/decor/ChapterMarks';
      ...
      <article className="chapter-page">
        ...
        {days.length === 0 ? (
          ...
          <>
            ...
            <ColophonRow label={`cyanotype · ${chapter.volume} · ${t(chapter.issueTitle)}`} />
          </>
        )}
